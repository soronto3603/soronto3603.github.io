...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(/*name*/ ctx[0]);
    			attr_dev(div, "class", div_class_value = "filter " + (/*isFocus*/ ctx[1] ? "active" : "") + " svelte-1bjxpbh");
    			add_location(div, file$4, 35, 0, 565);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*isFocus*/ 2 && div_class_value !== (div_class_value = "filter " + (/*isFocus*/ ctx[1] ? "active" : "") + " svelte-1bjxpbh")) {
    				attr_dev(div, "class", div_class_value);
    			}
    		},
    		i: noop,
    ...
    function create_each_block$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(67:2) {#each ['', '', ...names, '', ''] as name, index}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "box svelte-3jxfl4");
    			add_location(div, file$5, 65, 0, 1116);
    ...
    // (63:2) {#each combinations as synergy, index}
    function create_each_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			attr_dev(div0, "class", "synergy svelte-1qrr4t7");

    			attr_dev(div0, "style", div0_style_value = Object.keys(/*synergy*/ ctx[2].synergies).length < 3
    			? "bottom:20px;"
    			: "");

    			add_location(div0, file$6, 65, 3, 1920);
    			attr_dev(div1, "class", "champions svelte-1qrr4t7");
    			add_location(div1, file$6, 68, 3, 2075);
    			attr_dev(div2, "class", "line svelte-1qrr4t7");
    			add_location(div2, file$6, 63, 2, 1836);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(63:2) {#each combinations as synergy, index}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "synergyTitle svelte-1qrr4t7");
    			add_location(div0, file$6, 58, 1, 1605);
    			attr_dev(div1, "class", "numberDescription svelte-1qrr4t7");
    			add_location(div1, file$6, 60, 1, 1704);
    			attr_dev(div2, "class", "table");
    			add_location(div2, file$6, 61, 1, 1773);
    			add_location(p, file$6, 76, 1, 2303);
    			attr_dev(main, "class", "svelte-1qrr4t7");
    			add_location(main, file$6, 57, 0, 1597);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	async function reload() {
    		$$invalidate(0, combinations = [...(await loadData(synergy)).slice(offset * page, offset * page + offset)]);
    	...
    	return [combinations, currentCombinationsLength, synergy, handleMessage, page];
    }
